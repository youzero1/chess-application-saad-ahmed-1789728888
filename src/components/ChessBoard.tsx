...
export function ChessBoard({
  ...
  return (
    <div
      className="w-full rounded-lg p-[3.2%] shadow-[0_18px_50px_rgba(0,0,0,0.6),inset_0_2px_3px_rgba(255,235,200,0.25),inset_0_-3px_6px_rgba(0,0,0,0.5)]"
      style={{
        background:
          'repeating-linear-gradient(93deg, #6b4423 0px, #5b3a1e 14px, #4e3016 28px, #66411f 46px, #583719 60px, #6b4423 78px)',
      }}
    >
